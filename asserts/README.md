...
|:---|:---|:---|
| `architecture.png` | Fig. 2 | Overall HFA-Mamba architecture (hero image) |
| `hfrm.png` | Fig. 4 | High-Frequency Refocus Module |
| `heatmap.png` | Fig. 6 | HFRM activation heatmaps (evidence it focuses on targets) |
| `afo.png` | Fig. 8 | Qualitative results on AFO (the headline dataset) |

Optional extras you may add and reference if desired: `teaser.png` (Fig. 1),
